package com.foodmarket.report.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, OrderDeliveredEvent> orderDeliveredConsumerFactory() {
        JsonDeserializer<OrderDeliveredEvent> deserializer = new JsonDeserializer<>(OrderDeliveredEvent.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, OrderDeliveredEvent> orderDeliveredListenerFactory() {
